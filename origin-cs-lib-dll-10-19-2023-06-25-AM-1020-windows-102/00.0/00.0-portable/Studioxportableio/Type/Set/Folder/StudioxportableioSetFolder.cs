...
namespace Core
{
    ...
    {
        public static IList<DirectoryInfo> StudioxportableioFolderSet(String DirectoryFullName___VALUE, Boolean answer_SELF_should)
        {
            ...
            {
                deflect[1] = StudioxportableioFolderSetSurface(stringValue, answer_SELF_should);
