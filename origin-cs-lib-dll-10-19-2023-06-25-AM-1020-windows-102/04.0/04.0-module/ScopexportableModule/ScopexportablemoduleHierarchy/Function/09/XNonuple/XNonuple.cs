...
namespace Core
{
    ...
    public partial class ScopexportablemoduleHierarchy
    {
        ...
        public partial struct XNonuple
        {
            ...
            public Scopexportablestringsafe Identity;

            public Scopexportablestringsafe Link;
            ...
            public override String ToString()
            {
                return String.Join('\n'.ToString(), new String[] {
                    ...
                    String.Empty + '\t' + '~' + "18" + ' ' + nameof(Identity) + ':' + ' ' + "<hidden>",
                    String.Empty + '\t' + '~' + "19" + ' ' + nameof(Identity) + ':' + ' ' + Identity.ValueSafe,
                    String.Empty + '\t' + '~' + "20" + ' ' + nameof(Link) + ':' + ' ' + "<hidden>",
                    String.Empty + '\t' + '~' + "21" + ' ' + nameof(Link) + ':' + ' ' + Link.ValueSafe,
                    String.Empty + '}',
                    String.Empty,
