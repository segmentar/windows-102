...
namespace Core
{
    ...
    {
        public static IList<FileInfo> BootxportableioFileSet(String DirectoryFullName___VALUE, Boolean answer_SELF_should)
        {
            ...
            deflect[0] = BootxportableioFolderSetSurface(DirectoryFullName___VALUE, answer_SELF_should);
