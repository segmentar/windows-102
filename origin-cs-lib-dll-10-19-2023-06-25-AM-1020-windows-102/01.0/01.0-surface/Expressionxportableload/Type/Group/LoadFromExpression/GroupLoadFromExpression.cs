...
namespace Core
{
    ...
    {
        public static Expressionxportable GroupLoadFromExpression(Expressionxportableloadcontext value_EXPRESSIONXPORTABLELOADCONTEXT, Expressionxportablereadclose value_EXPRESSIONXPORTABLEREADCLOSE, String FileName__VALUE)
        {
