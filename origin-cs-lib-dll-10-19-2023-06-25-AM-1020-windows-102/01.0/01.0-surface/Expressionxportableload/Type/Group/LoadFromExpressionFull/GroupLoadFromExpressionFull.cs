...
namespace Core
{
    ...
    {
        public static Expressionxportable GroupLoadFromExpressionFull(String FileName__VALUE)
        {
            ...
            var result = GroupLoadFromExpression((Expressionxportableloadcontext)inflect[0], (Expressionxportablereadclose)inflect[1], FileName__VALUE);
