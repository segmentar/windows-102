...
namespace Core
{
    ...
    {
        public static Materialxportable GroupLoadFromCurrentDirectory(Materialxportableloadcontext value_MATERIALXPORTABLELOADCONTEXT, Materialxportablereadclose value_MATERIALXPORTABLEREADCLOSE, String FileName__VALUE)
        {
