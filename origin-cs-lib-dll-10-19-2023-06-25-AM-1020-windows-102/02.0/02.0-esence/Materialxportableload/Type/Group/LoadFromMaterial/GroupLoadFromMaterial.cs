...
namespace Core
{
    ...
    {
        public static Materialxportable GroupLoadFromMaterial(Materialxportableloadcontext value_MATERIALXPORTABLELOADCONTEXT, Materialxportablereadclose value_MATERIALXPORTABLEREADCLOSE, String FileName__VALUE)
        {
